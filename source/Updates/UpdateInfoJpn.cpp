...
UpdateInfoJpn::UpdateInfoJpn(int deviceType) {
    ...
    if (deviceType == 2 || deviceType == 4) {
        ...
        items.push_back(UpdateItem("ab59d89faba5738b6ac85059fe324e06", "/updates/0004003000008202.cia"));
        ...
        items.push_back(UpdateItem("507d919d9357b216e66f526499c8cfd5", "/updates/000400300000c602.cia"));
        ...
        items.push_back(UpdateItem("37c61d1c042a44f45bde722627c1c05b", "/updates/0004009b00012202.cia"));
        items.push_back(UpdateItem("b27d85b97fd94fd6fb78bf713cc0dd4f", "/updates/000400db00010302.cia"));
        items.push_back(UpdateItem("97999b9818be32e0f75701b76aa3f0b5", "/updates/000400db00010502.cia"));
        items.push_back(UpdateItem("2b1f0bf0552d7104b6c58edcf01a711c", "/updates/000400db00017202.cia"));
        items.push_back(UpdateItem("26841e0d429854a7fe68cdfd3dd684a0", "/updates/000400db20016202.cia"));
        items.push_back(UpdateItem("9d15d4e00399b7bc0d530e1a202c0cf5", "/updates/0004013000001502.cia"));
        ...
        items.push_back(UpdateItem("11825a0c976abb5c93531002e4333bba", "/updates/0004013000002802.cia"));
        ...
        items.push_back(UpdateItem("d5cbabfb8b59c0dd623320f546a5cbda", "/updates/0004013000002c02.cia"));
        ...
        items.push_back(UpdateItem("b1052df99a4abff13b038630640066da", "/updates/0004013000003302.cia"));
        items.push_back(UpdateItem("c88ae7a3b565db540e70e01b727bad69", "/updates/0004013000003402.cia"));
        ...
        items.push_back(UpdateItem("671429499d7f11319d6df27648d4a659", "/updates/0004013000008002.cia"));
        items.push_back(UpdateItem("479c987c0a96914049c8e83132f61d33", "/updates/0004013020001503.cia"));
        items.push_back(UpdateItem("3f2f0bc75fac12f9b79a9aae9781b7d1", "/updates/0004013020001602.cia"));
        ...
        items.push_back(UpdateItem("0e46936b00c74b035c34f3261ac82ee1", "/updates/0004013020004002.cia"));
